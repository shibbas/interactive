...
`;
        ...
        dynamicTokenProvider.augmentNotebookGrammar(testUri, updatedKernelInfos);
...
`;
        ...
        dynamicTokenProvider.augmentNotebookGrammar(testUri, [newKernelInfo]);
    ...
    it('tokens are parsed when kernel specifies a language alias instead of the root language name', async () => {
        ...
        dynamicTokenProvider.augmentNotebookGrammar(testUri, [kernelInfoWithAlias]);
...
# Perl comment`;
    ...
    beforeEach(async () => {
        ...
        dynamicTokenProvider.augmentNotebookGrammar(testUri, defaultKernelInfos);
    });
