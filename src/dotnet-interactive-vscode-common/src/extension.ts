...
export async function activate(context: vscode.ExtensionContext) {
    ...
    onKernelInfoUpdates.push((compositeKernel) => {
        ...
        if (notebookUri) {
            ...
            tokensProvider.dynamicTokenProvider.augmentNotebookGrammar(notebookUri, kernelInfos);
    ...
    context.subscriptions.push(vscode.workspace.onDidOpenNotebookDocument(async notebook => {
        ...
        tokensProvider.dynamicTokenProvider.augmentNotebookGrammar(notebook.uri, kernelInfos);
    }));
